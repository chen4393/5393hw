...
sample command: > ./aleae question_a.in question_a.r 1000 -1 0 question_a.out

Test steps:
1. make clean
2. make
3. pass the following command > ./aleae test.in test.r 1000 -1 0 question_a.out to the command line
4. check the question_a.out generated
